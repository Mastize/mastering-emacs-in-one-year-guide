...
* 简介
成为高手很容易. 我初学Emacs时常忘记"退出"的快捷键, 一年后我[[https://github.com/redguardtoo][完全掌握了Emacs]].

很多文章强调Emacs有多牛, 但关于"如何做"则语焉不详. 即使涉及到"如何做", 谈细节多而方法论少.

很多人花了大量时间"学习"Emacs最终缺选择放弃,就是方法论上出了问题. 

本文就 *侧重方法论*.

比如背很少用到的快捷键就是事倍功半.实际上记20个最常用的快捷键就足够了.其他按键在使用过程中会自然掌握.

除本文之外的任何一本Emacs教程都会列出至少100个"常用"的快捷键.我不会教你任何快捷键,但是会告诉20个甚至更少的快捷键足够用了,而且会告诉你常用的是哪些快捷键.这就是教方法论但不拘泥于技术细节.
